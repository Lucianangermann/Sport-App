      ...
      <div className="px-5 pb-4">
        <div className="relative">
          <input
            ...
            className="w-full rounded-2xl border border-slate-200 bg-white px-12 py-3 text-sm outline-none transition focus:border-ink-900"
          />
          ...
          {CATEGORIES.map((c) => (
            <button
              ...
              className={`shrink-0 rounded-full px-3.5 py-1.5 text-xs font-semibold transition ${
                category === c.id ? 'bg-ink-900 text-white' : 'bg-white text-slate-700 shadow-card'
              }`}
            >
